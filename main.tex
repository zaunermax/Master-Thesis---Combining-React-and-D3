...
\title{Combining React and D3.js for Efficient Data Visualization in the Browser}
\author{Maximilian Zauner}
\programname{Interactive Media}
\placeofstudy{Hagenberg}
\dateofsubmission{2019}{06}{25}	% {YYYY}{MM}{DD}

%%% Entries for Bachelor theses only: -----------------------
%\thesisnumber{XXXXXXXXXX-A}   %e.g. 1310238045-A  
% (Stud-ID, A = 1st Bachelor thesis)
\semester{Spring Semester 2019} 	% Fall/Spring Semester YYYY
